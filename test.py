...
def test():
    ...
    company = Company(name="Acme", employees=[person1, person2], products={"software": Product(name="Acme Software", price=99.99), "hardware": Product(name="Acme Hardware", price=199.99)}, is_open=True, phone_numbers={"123-456-7890", "234-567-8901"}, departments=[("Sales", 10), ("Engineering", 20)])
    ...
    print(dict_to_dataclass(Company, x))
